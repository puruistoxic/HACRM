...
class ProductService extends TenantService
{
    ...
    private function storeProductThumbnail($model)
    {
        ...
        $images = [
            'path' => $this->uploadImage($image, 'product'),
    ...
    private function productRequest(): array
    {
        return [
            ...
            'trade' => $this->getAttr('trade'), 
            'sku' => $this->getAttr('sku'), 
            'promotrade' => $this->getAttr('promotrade'), 
            'promoretail' => $this->getAttr('promoretail'), 
            'itanal' => $this->getAttr('itanal'),
            'vegan' => $this->getAttr('vegan'),
            'vegetarian' => $this->getAttr('vegetarian'),
            'halal' => $this->getAttr('halal'), 
            'kosher' => $this->getAttr('kosher'), 
            'toplines' => $this->getAttr('toplines'),
            'additionallines' => $this->getAttr('additionallines')
        ];
    }
