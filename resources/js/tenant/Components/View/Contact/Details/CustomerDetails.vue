<template>
  <div class="content-wrapper">
    <div class="row">
      <div class="col-sm-8">
        <app-breadcrumb
          :page-title="ucWords($t('customer_details'))"
          :button="{
            label: $t('back_to_customers'),
            url: getAppUrl(CUSTOMER_LIST),
          }"
        />
      </div>
      <div class="col-sm-4">
                ...
                <p class="mt-2 mb-0">
                  ...
                  {{
                    customerData.customer_group
                      ? customerData.customer_group.name
                      : ''
                  }}
                </p>
                <p class="mt-2 mb-0 d-none" style="display: none">
                  <span class="text-muted">{{ $t('tin_number') }}: </span>
                  {{
                    customerData.tin ? customerData.tin : $t('not_added_yet')
                  }}
                </p>
                <p class="mt-4 mb-0" v-if="customerData.status_logs[0]">
                  <span class="text-muted"> {{ $t('status') }}: </span>
                  <span
                    :style="{
                      color: getStatusColor(customerData.status_logs[0].status),
                    }"
                    ><b> {{ customerData.status_logs[0].status }} </b></span
                  >
                </p>
              </div>
            </div>
                  ...
                  <div class="border-right custom">
                    ...
                    <div class="media mb-4 mb-xl-0">
                      ...
                      <div class="media-body">
                        ...
                        <div
                          class="d-flex"
                          v-if="$optional(customerData, 'contacts', 'email')"
                        >
                          <div>
                            <p
                              class="mb-0"
                              v-if="index < emailShow"
                              v-for="(email, index) in customerData.contacts
                                .email"
                            >
                              {{ email.value }}
                            </p>
                          ...
                          <div
                            v-if="
                              emailShow < customerData.contacts.email.length ||
                              customerData.contacts.email.length > emailShow
                            "
                          >
                            <a
                              href="#"
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                  <div class="media mb-4 mb-xl-5">
                    <div class="align-self-center mr-3">
                      <app-icon
                        name="pound-sign"
                        style="font-size: 28px; color: #4466f2"
                      />
                    </div>
                    <div class="media-body">
                    ...
                    <div class="media-body">
                      ...
                      <div
                        ...
                        v-if="
                          ...
                          customerData.contacts.phone_number
                        "
                      >
                        <div>
                          <p
                            ...
                            v-for="(phone, index) in customerData.contacts
                              .phone_number"
                          >
                            {{ phone.value }}
                          </p>
                        ...
                        <div
                          v-if="
                            phoneNumberShow <
                              customerData.contacts.phone_number.length ||
                            customerData.contacts.phone_number.length >
                              phoneNumberShow
                          "
                        >
...
export default {
    ...
    return {
      ...
      tabs: [
        ...
        },
        {
          ...
          component: 'app-customer-contact-person',
          permission: '',
          props: this.customerId,
        },
        {
        ...
        },
        {
          ...
          component: 'app-customer-activities',
          permission: '',
          props: this.customerId,
        },
        {
  ...
  computed: {
    ...
    profile_picture_link() {
      ...
      return urlGenerator('/images/avatar2.png')
    },
  },
  watch: {
    watch: {
