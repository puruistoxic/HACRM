...
export const PERSONS = `${TENANT_BASE_URL}app/persons`;
...
export const CUSTOMER_LIST = `${TENANT_BASE_URL}account/lists`;
export const PERSON_LIST = `${TENANT_BASE_URL}person/lists`;
...
export const CUSTOMER_DETAILS = `${TENANT_BASE_URL}/account/details/`;


export const CONTACTPERSON_DETAILS = `${TENANT_BASE_URL}/contactperson/details/`;
export const CUSTOMERNAME_ID = `${TENANT_BASE_URL}app/get-customer-name-id`;

export const CUSTOMER_DATA = `${TENANT_BASE_URL}app/customer/details`;

// export const COTACTPERSON_DATA = `${TENANT_BASE_URL}app/contact-person/details`;
...
export const CONTACTPERSON = `${TENANT_BASE_URL}app/customer/contactperson`;
export const NOTE = `${TENANT_BASE_URL}app/contactperson/note`;
export const ACTIVITY = `${TENANT_BASE_URL}app/contactperson/activity`;
export const PAYMENT = `${TENANT_BASE_URL}app/contactperson/payment`;
export const NOTEID = `${TENANT_BASE_URL}app/note-id`;
export const ACTIVITYID = `${TENANT_BASE_URL}app/activity-id`;
export const PAYMENTID = `${TENANT_BASE_URL}app/payment-id`;
// export const CONTACTPERSON = `${TENANT_BASE_URL}app/customer/contact`;
export const CUSTOMER_ADDRESS = `${TENANT_BASE_URL}app/address`;
// export const CUSTOMER_CONTACTPERSON = `${TENANT_BASE_URL}app/contact`;
export const CUSTOMER_CONTACTPERSON = `${TENANT_BASE_URL}app/contact-person`;
...
export const CUSTOMER_ID_CUSTOMER_GROUP = `${TENANT_BASE_URL}app/get-customer-name`;
