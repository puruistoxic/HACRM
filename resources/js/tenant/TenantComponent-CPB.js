...
Vue.component('app-person-modal', require('./Components/View/Contact/PersonCreateEditModal').default);
...
Vue.component('form-group-selectable', require('./Components/Helper/FromGroupSelectable').default);
Vue.component('app-customer-export-lists', require('./Components/View/Contact/CustomersExportLists').default);

Vue.component('app-person-list', require('./Components/View/Contact/Persons').default);

// Customer Details
Vue.component('app-customer-action', require('./Components/View/Contact/Details/CustomerAction').default);

Vue.component('app-person-customer-name', require('./Components/View/Contact/Details/ContactPersonCustomerAction').default);
Vue.component('app-customer-details', require('./Components/View/Contact/Details/CustomerDetails').default);
Vue.component('app-customer-contact-person', require('./Components/View/Contact/Details/ContactPerson').default);
Vue.component('app-customer-address', require('./Components/View/Contact/Details/Address').default);
Vue.component('app-customer-activities', require('./Components/View/Contact/Details/CustomerActivities').default);
...
Vue.component('app-date-picker', require('./Components/View/Contact/Details/Person/DatePicker').default);
Vue.component('app-dropdown-options', require('./Components/View/Contact/Details/Person/DropDown').default);
Vue.component('app-drop-down-options', require('./Components/View/Contact/Details/DropDownOptions').default);


Vue.component('app-contact-person-contact', require('./Components/View/Contact/Details/ContactPersonContact').default);
Vue.component('app-contact-person-details', require('./Components/View/Contact/Details/ContactPersonDetails').default);
Vue.component('app-contact-person-detail-info', require('./Components/View/Contact/Details/Person/PersonInfo').default);
Vue.component('app-contact-person-additional-info', require('./Components/View/Contact/Details/Person/AdditionalInfo').default);
Vue.component('app-contact-person-notes', require('./Components/View/Contact/Details/Person/Notes').default);
Vue.component('app-contact-person-notes-list', require('./Components/View/Contact/Details/Person/NoteList').default);
Vue.component('app-contact-person-notes-modal', require('./Components/View/Contact/Details/Person/NoteCreateEditModal').default);


Vue.component('app-contact-person-payment', require('./Components/View/Contact/Details/Person/Payments').default);
Vue.component('app-contact-person-payments-modal', require('./Components/View/Contact/Details/Person/PaymentCreateEditModal').default);


Vue.component('app-contact-person-activities', require('./Components/View/Contact/Details/Person/Activity').default);
Vue.component('app-contact-person-activities-modal', require('./Components/View/Contact/Details/Person/ActivityCreateEditModal').default);
...
Vue.component('app-customer-contact-person-info', require('./Components/View/Contact/Details/ContactPersonInfo').default);

Vue.component('app-address-modal', require('./Components/View/Contact/Details/AddressCreateEditModal').default);
Vue.component('app-contact-person-modal', require('./Components/View/Contact/Details/ContactPersonCreateEditModal').default);
Vue.component('app-person-action', require('./Components/View/Contact/Details/ContactPersonAction').default);
...
Vue.component('app-hilton-report', require('./Components/View/Reports/HiltonReport').default);
Vue.component('app-sales-insights-report', require('./Components/View/Reports/SalesInsightsReport').default);
Vue.component('app-sales-insights-q-report', require('./Components/View/Reports/SalesInsightsQReport').default);

//healthaid reports
Vue.component('app-product-sales-report', require('./Components/View/Reports/ProductSalesReport').default);
Vue.component('app-customer-group-2010-2019-report', require('./Components/View/Reports/CustomerGroupReport').default);

Vue.component('app-product-sales-and-units-report', require('./Components/View/Reports/ProductSales&UnitsReport').default);

Vue.component('app-year-on-year-july-report', require('./Components/View/Reports/YearonYearJulyReport').default);

Vue.component('app-visitors-and-sales-report', require('./Components/View/Reports/Visitors&SalesReport').default);

Vue.component('app-yearly-sales-2016-2023-report', require('./Components/View/Reports/YearlySalesReport').default);

Vue.component('app-monthly-debtors-report', require('./Components/View/Reports/MonthlyDebtorsReport').default);

Vue.component('app-sales-2022-2023-report', require('./Components/View/Reports/SalesReport').default);

Vue.component('app-customer-group-2013-2023-report', require('./Components/View/Reports/CustomerGroupOneReport').default);

Vue.component('app-country-wise-turnover-report', require('./Components/View/Reports/CountryWiseTurnoverReport').default);

Vue.component('app-healthaid-year-sales-report', require('./Components/View/Reports/HealthAidYearlySalesReport').default);

Vue.component('app-healthaid-shopify-report', require('./Components/View/Reports/HealthAidShopifyReport').default);

Vue.component('app-healthaid-social-media-report', require('./Components/View/Reports/HealthAidSocialMediaReport').default);

Vue.component('app-healthaid-sales-insight-report', require('./Components/View/Reports/HealthAidSalesInsightReport').default);
