...
use Database\Seeders\App\Traits\NotePermissionTrait;
use Database\Seeders\App\Traits\PaymentPermissionTrait;
use Database\Seeders\App\Traits\ActivityPermissionTrait;
use Database\Seeders\App\Traits\ContactPersonPermissionTrait;
...
class PermissionAppSeeder extends Seeder
{
    use DisableForeignKeys,
        RolePermissionTrait,
        SettingPermissionTrait,
        TemplatePermissionTrait,
        UserPermissionTrait,
        LotPermissionTrait,
        BranchWarehousePermissionTrait,
        StockPermissionTrait,
        StockAdjustmentPermission,
        GenerateAndPrintBarOrQrCodePermissionTrait,
        InternalTransferPermissionTrait,
        ProductPermissionTrait,
        GroupPermissionTrait,
        CategoryPermissionTrait,
        SubCategoryPermissionTrait,
        BrandPermissionTrait,
        UnitPermissionTrait,
        AttributePermissionTrait,
        DashboardPermissionTrait,
        ExpensesPermissionTrait,
        ExpenseAreasPermissionTrait,
        CustomersPermissionTrait,
        SuppliersPermissionTrait,
        CustomerGroupPermissionTrait,
        ReportsPermissionTrait,
        CustomersPermissionTrait,
        SuppliersPermissionTrait,
        CustomerGroupPermissionTrait,
        SalesViewPermissionTrait,
        SalesReturnPermissionTrait,
        SalesInvoicePermissionTrait,
        AddressPermissionTrait,
        NotePermissionTrait,
        PaymentPermissionTrait,
        ActivityPermissionTrait,
        ContactPersonPermissionTrait;
    ...
    public function run()
    {
        ...
        $permission = array_merge(
            ...
            $this->notes($appId),
            $this->activities($appId),
            $this->payments($appId),
            $this->contactpersons($appId),
