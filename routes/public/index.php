...
use App\Http\Controllers\Tenant\Contacts\PersonsController;
...
Route::group(['prefix' => 'app'], function () {
    ...
    //Contact Person
    Route::get('contact-person/{customer}', [ContactPersonController::class, 'customerById'])->name('customerBy.id');

    Route::get('note/{contactperson}', [NoteController::class, 'noteById'])->name('customerBy.id');

    Route::get('note-id/{contactperson}', [NoteController::class, 'noteId'])->name('customerBy.id');

    Route::get('payment/{contactperson}', [PaymentController::class, 'PaymentById'])->name('paymentBy.id');

    Route::get('payment-id/{contactperson}', [PaymentController::class, 'paymentId'])->name('paymentBy.id');

    Route::get('activity/{contactperson}', [ActivityController::class, 'activityById'])->name('activity.id');

    Route::get('activity-id/{contactperson}', [ActivityController::class, 'activityIdd'])->name('activityBy.id');
    Route::get('all-activity/{contactperson}', [CustomerController::class, 'getCustomerActivity'])->name('allactivityBy.id');

    Route::get('app/contactperson/detail/{customer}', [ContactPersonController::class, 'index'])->name('contactperson.show');


    Route::patch('/activity/{activity}/complete', [ActivityController::class, 'completeActivity'])
    ->name('completeActivity.manage');
    ...
    // routes/api.php
    Route::get('get-customer-name', [ContactPersonController::class, 'getCustomerData']);
    Route::get('get-user-data', [UserController::class, 'getUserData']);

    Route::get('get-customer-name-id/{customer}', [ContactPersonController::class, 'getCustomerDataId']);
    Route::get('get-account-name-id/{customer}', [CustomerController::class, 'getAccountDataId']);
    ...
    Route::delete('/note-attachment/delete/{id}', [NoteController::class, 'deleteFile'])->name('delete.note');
...
Route::group(['prefix' => 'report'], function () {
    ...
    //Persons
    // Route::get('persons', [ContactPersonController::class, 'index'])->name('customer.report');

    Route::get('/customers/{customer}/contact-persons-details', [CustomerController::class, 'getContactPersonsByCustomer'])->name('get_contact_person');
